...
######
if($debug){
    $subscriptionname = "B_ONIPROD-CentralUS-AP-4969"
}
else{
...
if($debug){
    ...
    if($wafonly){
        $vmname = Read-Host -prompt "ap-waf-1st-z, ap-waf-1st-y, ap-waf-1sthourly-x, ap-waf-1sthourly-w, bp-waf-1sthourly-s, bp-waf-1sthourly-t" #"ap-waf-1st-z"
    }
    else{
...
######
if($debug){
    $Targetsubscriptionname = "B_ONIPROD-EastUS2-BP-4969"
}
else{
...
if($debug){
    $targetservicename = "BDS-BP-WAF-1ST"
}
else {
...
if($debug){
    $targetvmname = "bp-waf-1sthourly-s"
}
else{
    if($wafonly){
        $targetvmname = Read-Host -prompt "ap-waf-1st-z, ap-waf-1st-y, ap-waf-1sthourly-x, ap-waf-1sthourly-w, bp-waf-1sthourly-s, bp-waf-1sthourly-t" #"ap-waf-1st-z"
    }
    else{
